...
highlight Comment      ctermfg=4   ctermbg=8 cterm=none
...
" diff highlights
highlight DiffAdd      ctermfg=none   ctermbg=2    cterm=none
highlight DiffChange   ctermfg=none ctermbg=none cterm=none
highlight DiffDelete   ctermfg=none    ctermbg=1    cterm=none
