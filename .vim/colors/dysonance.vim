...
" Diff highlights
highlight DiffAdd      ctermfg=Green       ctermbg=DarkGreen  cterm=none
highlight DiffChange   ctermfg=none        ctermbg=none       cterm=none
highlight DiffDelete   ctermfg=Red         ctermbg=DarkRed    cterm=none
highlight DiffText     ctermfg=Yellow      ctermbg=DarkYellow cterm=bold,underline
