...
syntax match   juliaBaseTypeOther	display "\<\%(RemoteRef\|Task\|Condition\|VersionNumber\|IPv[46]\|SerializationState\|WorkerConfig\|Future\|RemoteChannel\|IPAddr\|Stack\%(Trace\|Frame\)\|\(Caching\|Worker\)Pool\|TS\|Strategy\|Portfolio\|Account\|Universe\|DataFrame\|DataArray\|DataVector\|DataMatrix\|Missing\|AbstractSerializer\)\>"
...
syntax match   juliaConstGeneric	display "\<\%(nothing\|Main\|missing\|NA\)\>"
...
hi def link juliaParDelim		Delimiter
hi def link juliaSemicolon		Delimiter
hi def link juliaComma  		Delimiter
...
hi def link juliaSymbolS		String
